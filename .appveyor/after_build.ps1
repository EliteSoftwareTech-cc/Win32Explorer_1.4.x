...
7z a $archiveName $env:APPVEYOR_BUILD_FOLDER\Win32Explorer\Win32Explorer\$env:platform\$env:configuration\Win32Explorer.exe
...
7z a explorerpp_${env:arch}_symbols.zip $env:APPVEYOR_BUILD_FOLDER\Win32Explorer\Win32Explorer\$env:platform\$env:configuration\Win32Explorer.pdb
